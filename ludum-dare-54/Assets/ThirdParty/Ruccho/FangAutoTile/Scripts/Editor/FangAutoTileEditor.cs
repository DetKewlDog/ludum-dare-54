...
namespace Ruccho.Fang
{
    ...
    public class FangAutoTileEditor : Editor
    {
        ...
        public static readonly string p_sprites = "Sprites";
        ...
        public override void OnInspectorGUI()
        {
            ...
            if (Foldout("generation", "Tile Generation Settings"))
            {
                using (new EditorGUI.IndentLevelScope())
                {
                    ...
                    EditorGUILayout.PropertyField(serializedObject.FindProperty(p_sprites));
                }
        ...
        private void GenerateTexture()
        {
            ...
            for (int i = 0; i < Mathf.Max(wholeChannels, compiledChannelsProp.arraySize); i++)
            {
                ...
                else
                {
                    ...
                    if (tex)
                    {
                        if (tex.width != texSize || tex.height != texSize || tex.format != format)
                        {
